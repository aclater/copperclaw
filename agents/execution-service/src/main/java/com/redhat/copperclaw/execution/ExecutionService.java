package com.redhat.copperclaw.execution;
...
public class ExecutionService {
    ...
    public void process(String message) {
        try {
            ...
            LOG.errorf(e, "EXECUTION processing error");
    ...
    private String buildCycleStateUpdate(String input, String output) {
        try {
            ...
            return "{\"event_type\":\"agent_error\",\"producing_agent\":\"EXECUTION\"}";
        }
    }
