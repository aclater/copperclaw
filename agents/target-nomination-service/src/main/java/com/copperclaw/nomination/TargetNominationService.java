package com.copperclaw.nomination;
...
@ApplicationScoped
public class TargetNominationService {

    private static final Logger LOG = Logger.getLogger(TargetNominationService.class);
    ...
    public void process(String message) {
        try {
            ...
            LOG.errorf(e, "TARGET-NOMINATION processing error");
    ...
    private String buildCycleStateUpdate(String input, String output) {
        try {
            ...
            return "{\"event_type\":\"agent_error\",\"producing_agent\":\"TARGET-NOMINATION\"}";
        }
    }
